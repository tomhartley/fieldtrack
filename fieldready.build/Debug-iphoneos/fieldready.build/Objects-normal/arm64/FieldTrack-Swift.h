...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FieldTrack",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10FieldTrack11AppDelegate")
...
SWIFT_CLASS("_TtC10FieldTrack22ConfirmationController")
...
SWIFT_CLASS("_TtC10FieldTrack11DataHandler")
...
SWIFT_CLASS("_TtC10FieldTrack10DetailView")
...
SWIFT_CLASS("_TtC10FieldTrack7RowView")
@interface RowView : UIView
@property (nonatomic, strong) IBOutlet UIView * _Null_unspecified contentView;
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified iconView;
@property (nonatomic, strong) IBOutlet UIView * _Null_unspecified topLineView;
...
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified checkmarkView;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10FieldTrack13SceneDelegate")
...
SWIFT_CLASS("_TtC10FieldTrack18SettingsController")
...
SWIFT_CLASS("_TtC10FieldTrack14ViewController")
